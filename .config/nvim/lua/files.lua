...
local custom_confirm = function(msg, default, type)
  local confirm_key = "j"
  local not_confirm_key = "n"
  local yes_label =  confirm_key .. "Yes"
  local no_label = not_confirm_key .. "No"

  local menu = yes_label .. "\n" .. no_label

  return vim.fn.confirm(msg, menu, default, type)
end
...
MiniFiles.synchronize = function()
  ...
  if fs_actions ~= nil then
    ...
    local confirm_res = custom_confirm(msg,default,type)
...
H.setup_config = function(config)
  ...
  H.check_type('mappings.confirm_key', config.mappings.confirm_key, 'string')
  H.check_type('mappings.not_confirm_key', config.mappings.not_confirm_key, 'string')
...
H.buffer_make_mappings = function(buf_id, mappings)
  ...
  buf_map('n', mappings.confirm_key,  MiniFiles.confirm_key,  'Confirm Key')
  buf_map('n', mappings.not_confirm_key,  MiniFiles.not_confirm_key,  'Not Confirm Key')
